...
import CartCard from '../cartCartMobile';
...
describe('Cart Card component', () => {
  ...
  it('deletes card', () => {
    ...
    const deleteButton = getByTestId('mobile-delete-button');
  ...
  it('increases quantity when add button is pressed', () => {
    ...
    const addQuantityButton = getByTestId('mobile-add-quantity');
  ...
  it('decreases quantity when delete button is pressed', () => {
    ...
    const decreaseQuantity = getByTestId('mobile-minus-quantity');
